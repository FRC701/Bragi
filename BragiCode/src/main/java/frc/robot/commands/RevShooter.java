...
public class RevShooter extends InstantCommand {
  private ShooterSubsystem mShooterSubsystem = new ShooterSubsystem();
  private double speed;

  public RevShooter(ShooterSubsystem shooterSubsystem, double speed) {
  ...
  public void initialize() {
    ...
    ShooterSubsystem.mShooterState = ShooterState.S_RevShooter;

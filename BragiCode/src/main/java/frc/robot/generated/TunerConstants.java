...
public class TunerConstants {
  ...
  private static final Slot0Configs steerGains =
      new Slot0Configs().withKP(100).withKI(0).withKD(0.0).withKS(0.15).withKV(2.35).withKA(0);
  ...
  // This needs to be tuned to your individual robot
  public static final double kSpeedAt12VoltsMps = 2; // 4.73
  ...
  private static final int kPigeonId = Constants.IMUConstants.kGyroDeviceNumber;
